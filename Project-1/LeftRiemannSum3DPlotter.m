...
(* Example usage of the function to plot the Left Riemann Sum of Sin from 0 to *Pi *)
(* and then export the plot as an STL file *)
myPlot = LeftRiemannSum3D[Cos, {0, 2*Pi}, 30, 0.1, False];
Export["cosPlot.stl", myPlot];
